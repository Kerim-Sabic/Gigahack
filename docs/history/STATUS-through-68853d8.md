...
- Remote 68853d89f47c6f7c668c17499844e7bc92399b46; GitHub CI 36188551810 PASS.
- CI f691425 initially failed because the API/test lock lacked NumPy. Same full-runtime
  NumPy pin added; CI now executes all 132 backend cases and the browser workflow.
- Actual ASR-child kill/retry recovered one completed chunk. Arbitrary-length upload,
  extraction checkpoints and full-app crash qualification remain open.
- Optional baseline imports passed, but security review found dependency advisories.
  Patched experimental dependency installation is running; optional inference still disabled.
  See DECISIONS/010-optional-model-preparation.md and optional model/advisory manifests.
